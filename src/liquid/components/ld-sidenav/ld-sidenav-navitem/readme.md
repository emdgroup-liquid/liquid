...
| `mode`          | `mode`            | Display mode. In secondary mode the navitem is less high, displays a filled dot instead of the icon and is hidden when the sidenav collapses. The tertiary mode is similar to secondary mode, with the navitem indented and the dot being empty and having a border. | `"primary" \| "secondary" \| "tertiary"`                                                                                                                                                                                                                                                                                                         | `undefined` |
