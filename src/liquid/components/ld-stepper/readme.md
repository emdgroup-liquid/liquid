...
<nav class="ld-stepper">
  <ol>
    ...
    <li class="ld-step ld-step--current ld-step--next ld-step--last-active">
      ...
      <button type="button" aria-current="step"></button>
    </li>
    <li class="ld-step"><button type="button" aria-disabled="true"></button></li>
    <li class="ld-step"><button type="button" aria-disabled="true"></button></li>
  </ol>
</nav>
{% endexample %}
...
<nav class="ld-stepper" style="min-width: 25rem">
  <ol>
    ...
    <li class="ld-step ld-step--current ld-step--next ld-step--last-active">
      <span class="ld-sr-only">Current: </span>
      <button type="button" aria-current="step">Payment</button>
    </li>
    <li class="ld-step"><button type="button" aria-disabled="true">Summary</button></li>
    <li class="ld-step"><button type="button" aria-disabled="true">Confirmation</button></li>
  </ol>
</nav>
{% endexample %}
...
<nav class="ld-stepper ld-stepper--vertical">
  <ol>
    ...
    <li class="ld-step ld-step--vertical"><button type="button" aria-disabled="true"></button></li>
    <li class="ld-step ld-step--vertical"><button type="button" aria-disabled="true"></button></li>
  </ol>
</nav>
{% endexample %}
...
<nav class="ld-stepper ld-stepper--vertical">
  <ol>
    ...
    <li class="ld-step ld-step--vertical"><button type="button" aria-disabled="true">Summary</button></li>
    <li class="ld-step ld-step--vertical"><button type="button" aria-disabled="true">Confirmation</button></li>
  </ol>
</nav>
{% endexample %}
...
<nav class="ld-stepper ld-stepper--vertical" style="width: 17rem">
  <ol>
    ...
    <li class="ld-step ld-step--vertical">
      <button type="button" aria-disabled="true">Summary</button>
      <span class="ld-step__description">
        Summary of your articles and all the previously given information
      </span>
    </li>
    <li class="ld-step ld-step--vertical">
      <button type="button" aria-disabled="true">Confirmation</button>
      <span class="ld-step__description">
...
<nav class="ld-stepper">
  <ol>
    ...
    <li class="ld-step ld-step--brand-color"><button type="button" aria-disabled="true">Summary</button></li>
    <li class="ld-step ld-step--brand-color"><button type="button" aria-disabled="true">Confirmation</button></li>
  </ol>
</nav>
...
<nav class="ld-stepper" style="min-width: 25rem">
  <ol>
    ...
    <li class="ld-step ld-step--skipped ld-step--optional">
      ...
      <button type="button">Part 2<br />(can be skipped)</button>
    </li>
    <li class="ld-step ld-step--done ld-step--optional ld-step--with-icon">
      <span class="ld-sr-only">Completed (was optional): </span>
      <button type="button">Part 3<br />(can be skipped)</button>
      <svg class="ld-icon" role="presentation" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="m12 4-6.592 6L2 6.6396" stroke="currentcolor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>
    </li>
    <li class="ld-step ld-step--current ld-step--next ld-step--last-active ld-step--optional">
      <span class="ld-sr-only">Current: </span>
      <button type="button" aria-current="step">Part 4<br />(can be skipped)</button>
    </li>
    <li class="ld-step ld-step--optional"><button type="button" aria-disabled="true">Part 5<br />(can be skipped)</button></li>
  </ol>
</nav>
{% endexample %}
...
<nav class="ld-stepper" style="min-width: 25rem">
  <ol>
    ...
    <li class="ld-step"><a aria-disabled="true">Summary</a></li>
    <li class="ld-step"><a aria-disabled="true">Confirmation</a></li>
  </ol>
</nav>
{% endexample %}
