...
<nav class="ld-stepper">
  <ol>
    <li class="ld-step ld-step--done ld-step--with-icon">
      ...
      <a href="components/ld-stepper/#billing"></a>
    ...
    <li class="ld-step ld-step--done ld-step--with-icon">
      <span class="ld-sr-only">Completed: </span>
      <a href="components/ld-stepper/#shipping"></a>
      <svg class="ld-icon" role="presentation" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="m12 4-6.592 6L2 6.6396" stroke="currentcolor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>
    </li>
    <li class="ld-step ld-step--current">
      <span class="ld-sr-only">Current: </span>
      <a aria-current="step"></a>
    </li>
    <li class="ld-step"><a></a></li>
    <li class="ld-step"><a></a></li>
  </ol>
</nav>
{% endexample %}
...
<nav class="ld-stepper">
  <ol>
    ...
    <li class="ld-step"><a>Summary</a></li>
...
<nav class="ld-stepper ld-stepper--vertical">
  <ol>
    ...
    <li class="ld-step ld-step--vertical"><a></a></li>
    <li class="ld-step ld-step--vertical"><a></a></li>
  </ol>
</nav>
{% endexample %}
...
<nav class="ld-stepper ld-stepper--vertical">
  <ol>
    ...
    <li class="ld-step ld-step--vertical"><a>Summary</a></li>
    <li class="ld-step ld-step--vertical"><a>Confirmation</a></li>
  </ol>
</nav>
{% endexample %}
...
<nav class="ld-stepper">
  <ol>
    ...
    <li class="ld-step ld-step--current ld-step--custom-icon ld-step--with-icon">
      <span class="ld-sr-only">Current: </span>
      <a aria-current="step">Payment</a>
