...
describe('ld-tooltip', () => {
  ...
  positions.forEach((position) => {
    it(`renders with position ${position}`, async () => {
      ...
      const trigger = component.querySelector('.ld-tooltip__trigger')
  ...
  it(`initializes on mouseenter, if trigger-type is "hover"`, async () => {
    ...
    expect(component.querySelector('.ld-tether-enabled')).not.toBe(null)
  })
  ...
  it(`does not initialize on click, if trigger-type is "hover"`, async () => {
    ...
    expect(component.querySelector('.ld-tether-enabled')).toBe(null)
  })
