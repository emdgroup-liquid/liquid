...
| `maxlength`    | `maxlength`     | Maximum length (number of characters) of `value`.                                                                     | `number \| string`                               | `undefined` |
| `min`          | `min`           | Minimum value.                                                                                                        | `number \| string`                               | `undefined` |
| `minlength`    | `minlength`     | Minimum length (number of characters) of `value`.                                                                     | `number \| string`                               | `undefined` |
