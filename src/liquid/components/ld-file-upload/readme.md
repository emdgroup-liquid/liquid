...
{% example %}
<ld-file-upload multiple show-progress immediate style="width: 30rem"></ld-file-upload>
...
{% example %}
<ld-file-upload multiple show-progress allow-pause style="width: 30rem"></ld-file-upload>
