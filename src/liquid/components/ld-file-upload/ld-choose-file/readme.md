...
| `startUploadClicked`     | `start-upload-clicked`     | Defines whether start upload button has been clicked (only relevant when startUploadImmediately is false) | `boolean`      | `false`                                                                             |
